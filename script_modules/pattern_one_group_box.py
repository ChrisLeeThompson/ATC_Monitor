"""
Module for managing the pattern one group box.
"""
import logging
...
class PatternOneGroupBox(QGroupBox):
    ...
    def _create_components(self):
        ...
        self.rtm_plot.setObjectName("Pattern 1 RTM Plot")
        # Mean pixel value / specimen current plot
        self.mean_pixel_plot = PixelCurrentPlotWidget(parent=self, min_height=200)
        self.mean_pixel_plot.setObjectName("Pattern 1 Pixel Current Plot")
        ...
        self.match_score_plot.setObjectName("Pattern 1 Match Score Plot")
